...
class TestSplitNodesLink(unittest.TestCase):
    def test_split_nodes_link_without_text_nodes(self):
        nodes = [TextNode(text="Hello, there!", type=TextType.BOLD)]
        new_nodes = split_nodes_link(nodes)

        self.assertEqual(len(new_nodes), 1)

        self.assertEqual(new_nodes[0].type, TextType.BOLD)
        self.assertEqual(new_nodes[0].text, 'Hello, there!')
        self.assertEqual(new_nodes[0].url, None)

    def test_split_nodes_link_no_links_single_node(self):
    ...
    def test_split_nodes_link_no_links_multiple_nodes(self):
        nodes = [
    ...
    def test_split_nodes_link_with_single_link_node(self):
        nodes = [
            TextNode(
    ...
    def test_split_nodes_link_with_multiple_link_nodes(self):
        nodes = [
            TextNode(
                text="[Hello, there!](https://www.boot.dev)",
                type=TextType.TEXT,
    ...
    def test_split_nodes_link_with_single_node_that_contains_a_single_link_at_the_end_of_the_text(self):
        nodes = [
            TextNode(
    ...
    def test_split_nodes_link_with_single_node_that_contains_a_single_link_at_the_beginning_of_the_text(self):
        nodes = [
            TextNode(
    ...
    def test_split_nodes_link_with_single_node_that_contains_a_single_link_in_the_middle_of_the_text(self):
        nodes = [
            TextNode(
    ...
    def test_split_nodes_link_with_complex_scenario(self):
        nodes = [
            TextNode(
            ...
            TextNode(
                text="Oh wow, look at this: [Link to boot.dev](https://www.boot.dev)",
                type=TextType.TEXT,
            ),
            TextNode(
                text="General Kenobi!",
        ...
        self.assertEqual(new_nodes[3].text, 'Link to boot.dev')
        ...
        self.assertEqual(new_nodes[6].type, TextType.LINK)
