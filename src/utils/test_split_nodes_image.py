...
class TestSplitNodesImage(unittest.TestCase):
    ...
    def test_split_nodes_image_with_single_node_that_contains_a_single_image_at_the_end_of_the_text(
        self,
    ):
        nodes = [
            TextNode(
    ...
    def test_split_nodes_image_with_single_node_that_contains_a_single_image_at_the_beginning_of_the_text(
        self,
    ):
        nodes = [
            TextNode(
    ...
    def test_split_nodes_image_with_single_node_that_contains_a_single_image_in_the_middle_of_the_text(
        self,
    ):
        nodes = [
            TextNode(
