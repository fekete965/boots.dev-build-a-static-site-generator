...
class TestMarkdownToHtmlNode(unittest.TestCase):
    ...
    def test_paragraph_with_link(self):
        expected_html = (
            '<div><p>Check out <a href="https://example.com">this link</a> for more info</p></div>'
        )
        markdown_text = inspect.cleandoc(
    ...
    def test_paragraph_with_image(self):
        ...
        markdown_text = inspect.cleandoc(
            """Here's an image ![cool image](https://example.com/img.png)!"""
        )
        node = markdown_to_html_node(markdown_text)
        self.assertEqual(node.to_html(), expected_html)
    ...
    def test_mixed_inline_markdown(self):
        ...
        markdown_text = inspect.cleandoc(
            """This has *bold*, _italic_, ```code```, [link](https://example.com), and ![image](https://example.com/img.png)!"""
        )
        node = markdown_to_html_node(markdown_text)
        self.assertEqual(node.to_html(), expected_html)
